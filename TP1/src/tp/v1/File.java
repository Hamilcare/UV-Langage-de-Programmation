...
public class File<T> implements IFile<T> {
	...
	/**
	 *
	 * @return la tête de la liste Complexité constante o(1)
	 */
	private T getHead() {
		return head;
	}
	...
	/**
	 *
	 * @return le prochain élement de la file Complexité constante o(1)
	 */
	 ...
	 *
	 * @param nextListe
	 *            file à ajouter Complexité constante o(1)
	 */
	 ...
	 *
	 * @param head
	 *            Nouvelle tête de liste Complexité constante
	 */
	...
	/**
	 *
	 * @return le premier élement de la liste sans le supprimer Complexité
	 *         constante
	 */
	@Override
	public T get() {
	...
	/**
	 *
	 * @return le nombre d'élements contenu dans la file Complexité linéaire
	 *         o(n)
	 */
	@Override
	public int count() {
	 ...
	 *
	 * @param element
	 *            Element à ajouter en tête de file Complexité constante o(1)
	 */
	@Override
	...
	/**
	 *
	 * @return vrai si la liste est vide Complexité constante o(1)
	 */
	@Override
